...
Customer.create_partial(name="CustomerPostAndPut", include={"first_name", "last_name", "company", "address", "city", "state", "country", "postal_code", "phone", "fax", "email", "support_rep_id"})
Employee.create_partial(name="EmployeePostAndPut", include={"last_name", "first_name", "title", "birth_date", "hire_date", "address", "city", "state", "country", "postal_code", "phone", "fax", "email"})
Invoice.create_partial(name="InvoicePostAndPut", include={"customer_id", "invoice_date", "billing_address", "billing_city", "billing_state", "billing_country", "billing_postal_code", "total"})
...
Track.create_partial(name="TrackPostAndPut", include={"name", "album_id", "media_type_id", "genre_id", "composer", "milliseconds", "bytes", "unit_price"})
